...
You can display a summary plot to help inform the number of PC's you're interested in. A threshold number of PC's will be determined based on the amount of variance you wish to explain, the default is 99%. If you wish to change this, supply cutoff to the optns as shown below. This threshold will be the default for the number of PC's displayed later unless otherwise specified. 
