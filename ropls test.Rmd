...
lo<-oplsda(X=BIOspcglyc[,1:8], Y=BIOspcglyc$age, type = "PLS", optns=list(predI = 3, permI= 100, scaleC="none"))
...
lot <-oplsdaPredict(model = lot, newdata = aaData)
lot3 <-oplsdaPredict(model = lot, newdata = BIOspcglyc[,1:8], optns=list(real = as.factor(BIOspcglyc$covid_status)))
...
plotScores(model=a, optns=list(color = BIOspcglyc$age ,ellipse = "hotellings"))
