...
lot<-oplsda(X=BIOspcglyc[,1:8], Y=BIOspcglyc$covid_status, type = "OPLS", optns=list(predI = 3, permI= 100))
...
```{r}
lot2 <-eruptionPlot(model = lot, optns=list(y="pval", x="fc", factor = BIOspcglyc$covid_status)) 
