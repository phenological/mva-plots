...
plotScores(model=lot, optns = list(ellipse = "color"))
...
#ropls objects
fff <-plotScores(model = a, optns = list(color = BIOspcglyc$age, ellipse = "t", outlierLabels=BIOspcglyc$covid_status, annotation = BIOspcglyc[,10:12]))
