...
```{r}
#ggplot2, prcomp, GGally, roxygen2, stats, BioGenerics, dplyr??, sp??, ggpubr??
usethis::use_package("BioGenerics")
...
##working
a1<-pcaGrid(screeCumulativeThresholdObject = b, gridTitle = "new", CO="covid_status")
...
optns=list(colourCoding= "covid_status")
plotscores(model=b, optns= list(colourCoding)
```
...
```{r}
 ...
 p <- ggplot(data=a$pcdf, aes(x=a$pcdf$PC4, y=a$pcdf$PC5,  colour=10)) +
