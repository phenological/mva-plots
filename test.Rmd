...
#2) 
fff<- plotScores(model=a, optns=list(colourCoding=BIOspcglyc[,"covid_status"], ellipse="hotellings", outlierLabels=BIOspcglyc[,"patientID"]))
fff[["plots"]][["pcaGrid"]]
...
b <- eruptionPlot(model = a, factor=mtcars[,"vs"], optns=list(plotTitle = "mtcars eruption", method = "bonferroni"))
