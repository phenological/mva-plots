...
```{r}
#testthat, ggplot2, GGally, roxygen2, stats, dplyr??, sp??(included), ggpubr??
...
b<-plotScores(model=a, optns=list(colourCoding=iris[,5], colourTitle="species", ellipse="T", outlierLabels=rownames(iris)))
b[["plots"]][["pcaGrid"]]
```
